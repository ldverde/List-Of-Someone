...
import { Image, Alert, Linking, FlatList, Text, View, Pressable, ScrollView } from 'react-native';
...
function Item({ linkId }) {
  ...
  useEffect(() => {
    fetch(`https://www.googleapis.com/youtube/v3/videos?part=snippet&key=AIzaSyC6HIfXaIcu6EEI9NRwWMeLSxyKdIm7_rE&id=${linkId}`)
...
function HomeScreen() {
  ...
  return (
    ...
    <View style={ { paddingTop: insets.top }}>
      <TypingText/>
      <FlatList scrollEnabled={false} style={ styles.flat} data={lista}
